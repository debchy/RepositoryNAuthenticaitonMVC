...
namespace RepositoryNAuthenticaiton.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Display(Name = "Please accept terms and conditions")]
    ...
    public class ResetPasswordViewModel
    {
        ...
        [System.Web.Security.MembershipPassword(
            MinRequiredNonAlphanumericCharacters = 1,
            MinNonAlphanumericCharactersError = "Your password needs to contain at least one symbol (!, @, #, etc).",
            ErrorMessage = "Your password must be 6 characters long and contain at least one symbol (!, @, #, etc) and at least one capital and small letter."
        )]
        [DataType(DataType.Password)]
        [Display(Name = "Password")]
        public string Password { get; set; }
