namespace RepositoryNAuthenticaiton.Migrations.SchoolContext
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RepositoryNAuthenticaiton.DAL.SchoolContext>
    {
        ...
        protected override void Seed(RepositoryNAuthenticaiton.DAL.SchoolContext context)
        {
        ...
        void AddOrUpdateInstructor(RepositoryNAuthenticaiton.DAL.SchoolContext context, string courseTitle, string instructorName)
        {
